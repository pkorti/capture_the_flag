...
# When the detected flag is this large and centered, it is considered captured.
HIT_START_AREA = 30000
LOST_FRAMES_BEFORE_ABORT = 30
PAUSE_TIME = 2.0

# Prevent the same nearby flag from being immediately detected again
# after control returns to GPS.
    ...
    def process_detection(self, detection):
        ...
        # ----------------------------------------------------
            ...
            if pause_elapsed >= PAUSE_TIME:
                ...
                self.capture_cooldown_until = (
                    time.time() + CAPTURE_COOLDOWN
                )
